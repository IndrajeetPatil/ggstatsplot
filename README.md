...
`glmerMod`, `glmmTMB`, `gls`, `gam`, `Gam`, `gamlss`, `garch`, `glht`,
...
`logitsf`, `LORgee`, `lqm`, `lqmm`, `lrm`, `manova`, `maov`, `mcmc`,
...
`rlm`, `rlmerMod`, `robmixglm`, `rq`, `rqss`, `semLm`, `semLme`, `slm`,
