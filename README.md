...
| ------------ | ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Unpaired     | ![n \\times p](https://latex.codecogs.com/n%20%5Ctimes%20p "n \\times p") contingency table | Pearson’s ![\\chi^{2}](https://latex.codecogs.com/%5Cchi%5E%7B2%7D "\\chi^{2}") test    |
| Paired       | ![n \\times p](https://latex.codecogs.com/n%20%5Ctimes%20p "n \\times p") contingency table | McNemar’s ![\\chi^{2}](https://latex.codecogs.com/%5Cchi%5E%7B2%7D "\\chi^{2}") test    |
| Frequency    | ![n \\times 1](https://latex.codecogs.com/n%20%5Ctimes%201 "n \\times 1") contingency table | Goodness of fit (![\\chi^{2}](https://latex.codecogs.com/%5Cchi%5E%7B2%7D "\\chi^{2}")) |
