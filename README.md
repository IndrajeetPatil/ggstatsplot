...
| `ggcoefstats`                    | Random-effects meta-analysis                      | <font color="green">Yes</font> | <font color="red">No</font>    | <font color="red">No</font>    | <font color="green">Yes</font> |
...
`confusionMatrix`, `coxph`, `cpglm`, `cpglmm`, `complmrob`, `drc`,
...
`svyglm`, `tobit`, `truncreg`, `wbgee`, `wblm`, etc.
