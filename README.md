...
#>   label                                      y_position
#>   <chr>                                           <dbl>
#> 1 list(~italic(p)[Holm-corrected]==0.001)          34.7
#> 2 list(~italic(p)[Holm-corrected]==1.4e-05)        36.5
#> 3 list(~italic(p)[Holm-corrected]==2.57e-04)       38.3
#> 
#> $descriptive_data
#> NULL
#> 
