...
| [![Gitter chat](https://badges.gitter.im/gitterHQ/gitter.png)](https://gitter.im/ggstatsplot/community)                                                         | [![R build status](https://github.com/r-lib/actions/workflows/R/badge.svg)](https://github.com/IndrajeetPatil/ggstatsplot/actions?workflow=R)                                                |                                                                                                                                                   |                                                                                                                                                                |                                                                                                                                                                 |
...
`biglm`, `blmerMod`, `bracl`, `brglm2`, `brmsfit`, `btergm`, `cch`,
`clm`, `clmm`, `confusionMatrix`, `coxph`, `drc`, `emmGrid`, `epi.2by2`,
`ergm`, `felm`, `fitdistr`, `glmc`, `glmerMod`, `glmmTMB`, `gls`, `gam`,
`Gam`, `gamlss`, `garch`, `glm`, `glmmadmb`, `glmmPQL`, `glmmTMB`,
`glmRob`, `glmrob`, `gmm`, `ivreg`, `lm`, `lm.beta`, `lmerMod`,
...
`rlmerMod`, `rq`, `slm`, `speedglm`, `speedlm`, `stanreg`, `survreg`,
`svyglm`, `svyolr`, `svyglm`, `tobit`, `wbgee`, `wblm`, etc.
