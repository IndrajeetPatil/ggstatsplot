...
`lmerModLmerTest`, `lmodel2`, `lmRob`, `lmrob`, `logitmfx`, `LORgee`,
`lrm`, `mcmc`, `mcmc.list`, `MCMCglmm`, `mclogit`, `mmclogit`,
`mediate`, `mixor`, `mjoint`, `mle2`, `mlm`, `multinom`, `negbin`,
`negbinmfx`, `nlmerMod`, `nlrq`, `nlreg`, `nls`, `orcutt`, `plm`,
`poissonmfx`, `polr`, `ridgelm`, `rjags`, `rlm`, `rlmerMod`,
`robmixglm`, `rq`, `rqss`, `slm`, `speedglm`, `speedlm`, `stanfit`,
`stanreg`, `survreg`, `svyglm`, `svyolr`, `svyglm`, `tobit`, `truncreg`,
`vgam`, `wbgee`, `wblm`, `zcpglm`, `zeroinfl`, etc.
