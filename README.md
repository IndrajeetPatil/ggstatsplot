...
#> In case you want a `ggplot` object, set `marginal = FALSE`.Warning: This plot can't be further modified with `ggplot2` functions.
#> In case you want a `ggplot` object, set `marginal = FALSE`.Warning: This plot can't be further modified with `ggplot2` functions.
#> In case you want a `ggplot` object, set `marginal = FALSE`.Warning: This plot can't be further modified with `ggplot2` functions.
...
`BBmm`, `BBreg`, `bcplm`, `betamfx`, `betaor`, `bglmerMod`, `bife`,
`bigglm`, `biglm`, `blavaan`, `bmlm`, `blmerMod`, `bracl`, `brglm2`,
`brmsfit`, `brmultinom`, `btergm`, `cch`, `cgam`, `cgamm`, `cglm`,
`clm`, `clm2`, `clmm`, `clmm2`, `coeftest`, `complmrob`,
...
`logitmfx`, `logitor`, `LORgee`, `lrm`, `mcmc`, `mcmc.list`, `MCMCglmm`,
`mclogit`, `mmclogit`, `mediate`, `mixor`, `mjoint`, `mle2`, `mlm`,
`multinom`, `negbin`, `negbinmfx`, `negbinirr`, `nlmerMod`, `nlrq`,
`nlreg`, `nls`, `orcutt`, `plm`, `poissonmfx`, `poissonirr`, `polr`,
`ridgelm`, `rjags`, `rlm`, `rlmerMod`, `robmixglm`, `rq`, `rqss`, `slm`,
