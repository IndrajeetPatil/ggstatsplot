...
`gglmstats` creates a lot with the regression coefficients' point estimates as
dots with confidence interval whiskers. This is a wrapper function around
`dotwhisker::dwplot`.

```{r gglmstats1, message = FALSE, warning = FALSE, fig.height = 6, fig.width = 8}
...
```{r gglmstats2, message = FALSE, warning = FALSE, fig.height = 6, fig.width = 8}
ggstatsplot::gglmstats(
