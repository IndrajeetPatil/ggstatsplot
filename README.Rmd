...
[`{ggstatsplot}`](https://www.indrapatil.com/ggstatsplot/) is an extension
...
#| fig.alt = "Violin plot with boxplot overlay showing distribution of sepal length across three Iris species with statistical test results"
set.seed(123)
...
#| fig.height = 8,
#| fig.width = 12,
#| fig.alt = "Grouped violin plots comparing movie length by MPAA rating for Action and Comedy genres with statistical annotations"
set.seed(123)
...
If your repeated-measures data include an explicit subject identifier, it is
recommended that you pass it via `subject.id`; rows with missing identifiers
are ignored for paired grouping and repeated-measures statistics.

```{r}
#| label = "ggwithinstats1",
#| fig.width = 8,
#| fig.height = 6,
#| fig.alt = "Within-subjects violin plot showing wine taste ratings by wine type with paired data paths and statistical results"
set.seed(123)
...
#| fig.height = 6,
#| fig.width = 14,
#| fig.alt = "Grouped within-subjects violin plots showing desire to kill arthropods by condition for Europe and North America"
set.seed(123)
...
#| label = "gghistostats1",
#| fig.width = 8,
#| fig.alt = "Histogram showing distribution of time spent awake in mammals with one-sample test results"
set.seed(123)
...
#| fig.height = 6,
#| fig.width = 12,
#| fig.alt = "Grouped histograms showing movie budget distributions for Action and Comedy genres with statistical tests"
set.seed(123)
...
#| fig.height = 10,
#| fig.width = 8,
#| fig.alt = "Dot plot showing life expectancy distribution across Asian countries with robust one-sample test results"
set.seed(123)
...
#| fig.height = 6,
#| fig.width = 12,
#| fig.alt = "Grouped dot plots showing city miles per gallon by car manufacturer for 4 and 6 cylinder vehicles"
set.seed(123)
...
#| fig.height = 6,
#| warning = FALSE,
#| fig.alt = "Scatterplot with marginal distributions showing relationship between REM sleep and time awake in mammals with correlation results"
ggscatterstats(
  data  = ggplot2::msleep,
  x     = sleep_rem,
  y     = awake,
...
#| fig.width = 14,
#| warning = FALSE,
#| fig.alt = "Grouped scatterplots showing IMDB rating vs movie length for Action and Comedy genres with correlation annotations"
set.seed(123)
...
#| label = "ggcorrmat1",
#| warning = FALSE,
#| fig.alt = "Correlation matrix heatmap for mammals sleep dataset showing pairwise correlations with significance indicators"
set.seed(123)
...
#| fig.width = 10,
#| warning = FALSE,
#| fig.alt = "Grouped correlation matrices for Action and Comedy movie genres showing robust correlations"
set.seed(123)
...
#| fig.height = 4,
#| fig.width = 8,
#| fig.alt = "Pie charts showing transmission type distribution across cylinder groups in mtcars data with contingency table analysis"
set.seed(123)
...
#| fig.height = 6,
#| fig.width = 10,
#| fig.alt = "Grouped pie charts showing cylinder distribution for automatic and manual transmission vehicles"
set.seed(123)
...
alternatively use `ggbarstats()` function which has a similar syntax—including
support for one-sample goodness-of-fit tests.
...
#| fig.height = 8,
#| fig.width = 10,
#| fig.alt = "Stacked bar chart showing MPAA ratings distribution by movie genre with chi-squared test results"
set.seed(123)
library(ggplot2)
...
#| fig.height = 6,
#| fig.width = 10,
#| fig.alt = "Grouped bar charts showing cylinder distribution for automatic and manual transmission vehicles"
set.seed(123)
...
#| fig.height = 5,
#| fig.width = 6,
#| fig.alt = "Dot-and-whisker plot showing regression coefficients for mpg model with confidence intervals"
set.seed(123)
...
#| fig.height = 5,
#| fig.width = 6,
#| fig.alt = "Custom boxplot of Michelson-Morley experiment data with ggstatsplot-generated statistical subtitle"
...
✅ (GUI software alternatives: [JASP](https://github.com/jasp-stats/jasp-desktop) and [jamovi](https://www.jamovi.org/)).
