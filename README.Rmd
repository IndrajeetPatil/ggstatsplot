...
versions for most functions that makes it easy to repeat the same anlysis for any
grouping variable.
...
Given that `ggstatsplot` combines data visualization with statistical analysis,
it sits at the intersection of a big network of R packages from each domain.
