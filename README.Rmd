...
(`0.0.4.9000`). If you are in hurry and want to reduce the time of installation,
prefer-
...
All plots from `ggstatsplot` have a default theme: `theme_ggstatsplot`. For more on how
