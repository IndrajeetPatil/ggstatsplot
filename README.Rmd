...
common types of statisticla tests (**parametric**, **nonparametric**, and
...
```{r ggbetweenstats1, message = FALSE, warning = FALSE, dpi = 100}
...
```{r ggbetweenstats2, message = FALSE, warning = FALSE, dpi = 100}
library(ggplot2)
...
For example,
```{r ggbetweenstats3, message = FALSE, warning = FALSE, dpi = 100, fig.height = 10, fig.width = 6}
library(ggplot2)
library(cowplot)
...
```{r ggscatterstats1, message = FALSE, warning = FALSE, dpi = 100}
...
```{r ggscatterstats2, message = FALSE, warning = FALSE, dpi = 100}
library(datasets)
...
```{r ggpiestats1, message = FALSE, warning = FALSE, dpi = 100}
...
```{r ggpiestats2, message = FALSE, warning = FALSE, dpi = 100}
library(ggplot2)
...
```{r ggpiestats3, message = FALSE, warning = FALSE, dpi = 100}
library(ggplot2)
...
```{r gghistostats1, message = FALSE, warning = FALSE, dpi = 100}
library(datasets)
library(viridis)
...
*parametric*) or "np" (for *nonparametric*) or "bf" (for *Bayes Factor*). By
default, Bayes Factor quantifies the support for the alternative hypothesis (H1) over
the null hypothesis (H0) (i.e., BF10 is displayed).

```{r gghistostats2, message = FALSE, warning = FALSE, dpi = 100}
 ggstatsplot::gghistostats(
 data = NULL,
...
```{r ggcorrmat1, message = FALSE, warning = FALSE, dpi = 100, fig.height = 6, fig.width = 6}
...
```{r combine_plots_purrr1, message = FALSE, warning = FALSE, dpi = 100, fig.height = 12, fig.width = 8}
...
```{r combine_plots_purrr2, message = FALSE, warning = FALSE, dpi = 100, fig.height = 13, fig.width = 6}
library(tidyverse)
library(glue)
...
```{r theme_mprl, message = FALSE, warning = FALSE, dpi = 100, fig.height = 3, fig.width = 3}
library(ggplot2)
