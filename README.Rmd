...
*parametric*), "np" (for *nonparametric*), "r" (for *robust*). 

For example,
```{r ggbetweenstats3, message = FALSE, warning = FALSE, fig.height = 10, fig.width = 6}
library(ggplot2)
library(cowplot)
...
still use this function just to prepare the **plot** for exploratort data
analysis, but the statistical details will be incorrect. You can remove them by
adding `ggplot2::labs(subtitle = NULL)` to your code which will remove the
subtitle containing stats.
...
```{r theme_mprl, message = FALSE, warning = FALSE}
library(ggplot2)
