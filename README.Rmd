...
`ggstatsplot` also contains a helper function to combine multiple plots. This is a wrapper function around `cowplot::plot_grid` and lets you combine multiple plots and add combination of title, caption, and annotation texts.

```{r combine_plots, message = FALSE, warning = FALSE, fig.height = 10, fig.width = 7}
library(ggplot2)
