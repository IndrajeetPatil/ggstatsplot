...
still use this function just to prepare the **plot**, but the statistical
details will be incorrect. You can remove them by adding `labs(subtitle = NULL)`
to your code which will remove the subtitle containing stats.
