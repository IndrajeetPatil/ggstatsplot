...
with code that is both more succinct and easier to read. Although `plyr` was used to carry out
looped operations in prior examples, `purrr` is a much more powerful package and
