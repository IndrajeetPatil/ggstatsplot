...
```{r fig1, message = FALSE, warning = FALSE, fig.height = 8, fig.width = 10, fig.cap = "Note that assessing differences in mean values between groups has been made easier with the help of \\textit{position} of data points along a common scale (the Y-axis) and labels."}
# for reproducibility
set.seed(123)
