...
Functions | Description | Parametric | Non-parametric | Robust | Bayes Factor
------- | ------------------ | ---- | ----- | ----| ----- 
`ggbetweenstats` | Between group/condition comparisons |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$}
`ggwithinstats` | Within group/condition comparisons |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$}
`gghistostats`, `ggdotplotstats` | Distribution of a numeric variable |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$}
`ggcorrmat` | Correlation matrix |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{red}{$\times$}
`ggscatterstats` | Correlation between two variables |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{ForestGreen}{$\checkmark$}
`ggpiestats`, `ggbarstats` | Association between categorical variables |  \textcolor{ForestGreen}{$\checkmark$} | `NA` | `NA` |  \textcolor{ForestGreen}{$\checkmark$}
`ggpiestats`, `ggbarstats` | Equal proportions for categorical variable levels |  \textcolor{ForestGreen}{$\checkmark$} | `NA` | `NA` |  \textcolor{red}{$\times$}
`ggcoefstats` | Regression model coefficients |  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{red}{$\times$}|  \textcolor{ForestGreen}{$\checkmark$} |  \textcolor{red}{$\times$}
...
`ggpiestats` | Parametric | McNemar's test | Cohen's *g* |  \textcolor{ForestGreen}{$\checkmark$}
`ggpiestats` | Parametric | One-sample proportion test | Cramér's *V* |  \textcolor{ForestGreen}{$\checkmark$}
`ggscatterstats`/`ggcorrmat` | Parametric | Pearson's *r* | *r* |  \textcolor{ForestGreen}{$\checkmark$}
`ggscatterstats`/`ggcorrmat` | Non-parametric | $$\text{Spearman's}~ \rho$$ | $$\rho$$ |  \textcolor{ForestGreen}{$\checkmark$}
`ggscatterstats`/`ggcorrmat` | Robust | Percentage bend correlation | *r* |  \textcolor{ForestGreen}{$\checkmark$}
`gghistostats`/`ggdotplotstats` | Parametric | One-sample *t*-test | Cohen's *d*, Hedge's *g* |  \textcolor{ForestGreen}{$\checkmark$}
`gghistostats` | Non-parametric | One-sample Wilcoxon signed rank test | *r* |  \textcolor{ForestGreen}{$\checkmark$} 
`gghistostats`/`ggdotplotstats` | Robust | One-sample percentile bootstrap | robust estimator |  \textcolor{ForestGreen}{$\checkmark$}
`gghistostats`/`ggdotplotstats` | Parametric | Regression models | $$\beta$$ |  \textcolor{ForestGreen}{$\checkmark$}
...
----------- | ----------- | --------- | ----------------------- | -----
Parametric | between-subjects | No | Games-Howell test |  \textcolor{ForestGreen}{$\checkmark$} 
Parametric | between-subjects | Yes | Student's *t*-test |  \textcolor{ForestGreen}{$\checkmark$} 
Parametric | within-subjects | `NA` | Student's *t*-test |  \textcolor{ForestGreen}{$\checkmark$} 
Non-parametric | between-subjects | No | Dwass-Steel-Crichtlow-Fligner test |  \textcolor{ForestGreen}{$\checkmark$} 
Non-parametric | within-subjects | No | Durbin-Conover test |  \textcolor{ForestGreen}{$\checkmark$} 
Robust | between-subjects | No | Yuen's two-sample trimmed means *t*-test |  \textcolor{ForestGreen}{$\checkmark$} 
Robust | within-subjects | `NA` | Yuen's trimmed means test |  \textcolor{ForestGreen}{$\checkmark$}
