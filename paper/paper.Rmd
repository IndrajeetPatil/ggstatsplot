...
```{r, fig.width=8, fig.height=5, fig.cap="Example plot from the 'ggstatsplot' package illustrates its philosophy of juxtaposing informative visualizations with details from statistical analysis. To see all supported plots and statistical analysis, see the package website: https://indrajeetpatil.github.io/ggstatsplot/"}
library(ggstatsplot)
