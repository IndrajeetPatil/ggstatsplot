...
\NormalTok{)}
\CommentTok{\#> \# A tibble: 3 x 18}
\CommentTok{\#>   mpaa  counts  perc N         Action \textasciigrave{}Action Comedy\textasciigrave{} \textasciigrave{}Action Drama\textasciigrave{} Animated}
\CommentTok{\#>   <fct>  <int> <dbl> <chr>     <chr>  <chr>           <chr>          <chr>   }
\CommentTok{\#> 1 R        876  55.5 (n = 876) 11.30\% 3.42\%           9.25\%          0.57\%   }
\CommentTok{\#> 2 PG{-}13    506  32.0 (n = 506) 14.23\% 8.70\%           7.71\%          1.19\%   }
\CommentTok{\#> 3 PG       197  12.5 (n = 197) 7.61\%  7.11\%           1.02\%          15.23\%  }
\CommentTok{\#>   Comedy \textasciigrave{}Comedy Drama\textasciigrave{} Drama  \textasciigrave{}Romance Drama\textasciigrave{} RomCom statistic   p.value}
\CommentTok{\#>   <chr>  <chr>          <chr>  <chr>           <chr>      <dbl>     <dbl>}
\CommentTok{\#> 1 13.58\% 10.84\%         35.16\% 6.39\%           9.47\%      617.  4.15e{-}128}
\CommentTok{\#> 2 18.18\% 7.31\%          17.59\% 7.91\%           17.19\%     127.  1.07e{-} 23}
\CommentTok{\#> 3 24.87\% 10.66\%         15.74\% 5.08\%           12.69\%      70.4 4.10e{-} 12}
\CommentTok{\#>   parameter method                                   significance}
\CommentTok{\#>       <dbl> <chr>                                    <chr>       }
\CommentTok{\#> 1         8 Chi{-}squared test for given probabilities ***         }
\CommentTok{\#> 2         8 Chi{-}squared test for given probabilities ***         }
\CommentTok{\#> 3         8 Chi{-}squared test for given probabilities ***}
\end{Highlighting}
\end{Shaded}
