...
**Note**:
  - The function automatically decides whether an independent
  samples t-test is preferred (for 2 groups) or a Oneway ANOVA (3 or more groups)
  based on the number of levels in the grouping variable. 
  - The output of the function is a `ggplot` object which means that it can be further modified.
...
title and caption, better `x` and `y` axis labels, and tag and label the outliers in
