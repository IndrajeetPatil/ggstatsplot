...
**Note: **: The following demo uses the pipe operator (`%>%`), so in case you
are not familiar with this operator, here is a good explanation:
...
per capita, and population, every five years, from 1952 to 2007, for each of 142
countries and was collected by the Gapminder Foundation. Let's have a look at
the data-
...
So far we have only used the classic parametric test. The `type` (of test)
...
Let's focus on the following years to see these changes for every 10 years:
