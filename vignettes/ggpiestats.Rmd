...
investigate if the frequency of different types of fish caughts differs across
the two months:
...
which the boat B has been fishing. Additionally, facetted proportion tests also
reveal that all fish are not equally likely to be caught at this location with
cod being the most frequent fish caught.
