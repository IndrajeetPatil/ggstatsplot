...
So far we have been showing the count informatiton wiht the bar chart. Another
...
```{r grouped2, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 10}
...
# running function on every element of this list
plot_list <- purrr::pmap(.l = list(data = continent_list,
                                   x = "lifeExp",
                                   test.value = list(35.6, 58.4, 41.6, 64.7, 63.4),
                                   title = list(paste0("Continent: ", c("Africa",	"Americas",	"Asia",	"Europe", "Oceania"))),
                                   test.value.line = TRUE, 
                                   test.value.color = "black",
                                   centrality.para = "mean", 
                                   centrality.color = "blue", 
                                   low.color = list("#56B4E9", "#009E73", "#999999", "#0072B2", "#D55E00"),
                                   high.color = list("#D55E00", "#0072B2", "#F0E442", "#009E73", "#56B4E9")),
                         .f = ggstatsplot::gghistostats)

# combining all individual plots from the list into a single plot
