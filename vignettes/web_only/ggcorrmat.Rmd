...
By default, the gradient colors are derived from the `palette` parameter.
To use your own custom gradient, pass a `scale_fill_gradient2()` via
`ggplot.component`:

```{r}
#| label = "ggcorrmat_custom_colors",
#| fig.height = 8,
#| fig.width = 8

ggcorrmat(
  iris,
  ggplot.component = ggplot2::scale_fill_gradient2(
