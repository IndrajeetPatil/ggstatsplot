...
Behind the scenes, `{ggstatsplot}` uses `statsExpressions::statsExpressions::pairwise_comparisons()` function.
...
extract it with `extract_subtitle()` and pass it to `labs()`:
