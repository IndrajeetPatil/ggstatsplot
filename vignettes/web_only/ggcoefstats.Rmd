...
`lmRob`, `lmrob`, `logitmfx`, `LORgee`, `lrm`, `mcmc`, `mcmc.list`, `MCMCglmm`,
`mclogit`, `mmclogit`, `mediate`, `mixor`, `mjoint`, `mle2`, `mlm`, `multinom`,
`negbin`, `negbinmfx`, `nlmerMod`, `nlrq`, `nlreg`, `nls`, `orcutt`, `plm`,
`poissonmfx`, `polr`, `ridgelm`, `rjags`, `rlm`, `rlmerMod`, `robmixglm`, `rq`,
