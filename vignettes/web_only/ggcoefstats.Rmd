...
`cgam`, `cgamm`, `cglm`, `clm`, `clmm`, `coeftest`, `confusionMatrix`, `coxme`,
`coxph`, `cpglm`, `cpglmm`, `complmrob`, `DirichReg`, `drc`, `emmGrid`,
...
`svyglm`, `tobit`, `truncreg`, `vgam`, `wbgee`, `wblm`, etc.
...
```{r zeroinfl, warning = FALSE, message = FALSE, fig.height = 6, fig.width = 6, eval=FALSE}
# setup
set.seed(123)
library(pscl)
