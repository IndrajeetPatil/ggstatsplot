...
```{r vgam, fig.height = 4, fig.width = 6}
# setup
set.seed(123)
library(VGAM)
...
```{r cglm, fig.height = 8, fig.width = 6}
# setup
set.seed(123)
library(cglm)
data(teenpov)
...
```{r nlstanreg, fig.height = 5, fig.width = 5}
# setup
set.seed(123)
library(rstanarm)
...
```{r bayesx, fig.height = 6, fig.width = 6}
# setup
set.seed(111)
library(R2BayesX)
...
```{r MCMCglmm, fig.height = 6, fig.width = 6}
# setup
set.seed(123)
library(lme4)
library(MCMCglmm)
...
```{r blavaan, fig.height = 10, fig.width = 6}
# setup
set.seed(123)
library(blavaan)
