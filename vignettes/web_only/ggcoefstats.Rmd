...
`clm`, `clmm`, `coeftest`, `confusionMatrix`, `coxph`, `cpglm`, `cpglmm`,
`complmrob`, `drc`, `emmGrid`, `epi.2by2`, `ergm`, `feis`, `felm`, `fitdistr`,
`flexsurvreg`, `glmc`, `glmerMod`, `glmmTMB`, `gls`, `gam`, `Gam`, `gamlss`,
`garch`, `glm`, `glmmadmb`, `glmmPQL`, `glmRob`, `glmrob`, `gmm`, `hurdle`,
`ivreg`, `iv_robust`, `lavaan`, `lm`, `lm.beta`, `lmerMod`, `lmodel2`, `lmRob`,
...
```{r complmrob, warning = FALSE, message = FALSE, fig.height = 7, fig.width = 5}
# setup
set.seed(123)
library(complmrob)
...
# model
cragg_trunc <- truncreg(durable ~ age + quant,
  data = tobin,
  subset = durable > 0
)
