...
`glmmTMB`, `gls`, `gam`, `Gam`, `gamlss`, `garch`, `glht`, `glm`, `glmm`,
`glmmadmb`, `glmmPQL`, `glmRob`, `glmrob`, `glmx`, `gmm`, `hurdle`, `ivreg`,
`iv_robust`, `lavaan`, `lm`, `lm.beta`, `lmerMod`, `lmerModLmerTest`, `lmodel2`,
`lmRob`, `lmrob`, `logitmfx`, `logitor`, `logitsf`, `LORgee`, `lrm`, `manova`,
`maov`, `mcmc`, `mcmc.list`, `MCMCglmm`, `mclogit`, `mmclogit`, `mediate`,
...
`robmixglm`, `rq`, `rqss`, `slm`, `speedglm`, `speedlm`, `stanfit`, `stanreg`,
...
```{r manova, warning = FALSE, message = FALSE, fig.height = 8, fig.width = 8}
# setup
set.seed(123)
library(parameters)
...
```{r glmm, warning = FALSE, message = FALSE, fig.height = 5, fig.width = 5}
# setup
library(glmm)
data(BoothHobert)
set.seed(1234)
...
```{r bglmerMod, warning = FALSE, message = FALSE, fig.height = 4, fig.width = 4}
# for reproducibility
set.seed(123)
library(blme)
...
```{r stanmvreg, warning = FALSE, message = FALSE, fig.height = 5, fig.width = 5, eval=FALSE}
# setup
set.seed(123)
library(rstanarm)
