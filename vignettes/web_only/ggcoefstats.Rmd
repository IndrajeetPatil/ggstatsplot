...
`cgamm`, `cglm`, `clm`, `clm2`, `clmm`, `coeftest`, `complmrob`, `confusionMatrix`,
`coxme`, `coxph`, `cpglm`, `cpglmm`, `crch`, `DirichReg`, `drc`, `emmGrid`,
...
```{r robmixglm, warning = FALSE, message = FALSE, fig.height = 6, fig.width = 10, eval=FALSE}
# setup
set.seed(123)
library(robmixglm)
library(MASS)
...
```{r speedglm, warning = FALSE, message = FALSE, fig.height = 5, fig.width = 5, eval=FALSE}
# setup
set.seed(123)
library(speedglm)
