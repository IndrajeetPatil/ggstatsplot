...
`lmerModLmerTest`, `lmodel2`, `lmRob`, `lmrob`, `logitmfx`, `logitor`, `LORgee`,
`lrm`, `mcmc`, `mcmc.list`, `MCMCglmm`, `mclogit`, `mmclogit`, `mediate`,
`mixor`, `mjoint`, `mle2`, `mlm`, `multinom`, `negbin`, `negbinmfx`,
`negbinirr`, `nlmerMod`, `nlrq`, `nlreg`, `nls`, `orcutt`, `plm`, `poissonmfx`,
