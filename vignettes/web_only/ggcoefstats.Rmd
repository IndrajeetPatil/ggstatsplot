...
# plot
ggstatsplot::ggcoefstats(x = m.glm,
...
# plot
ggstatsplot::ggcoefstats(x = m.nb,
...
oranges_lm1 <- stats::lm(formula = sales1 ~ price1 + price2 + day + store, 
                         data = oranges)
...
ggstatsplot::ggcoefstats(x = marginal, 
