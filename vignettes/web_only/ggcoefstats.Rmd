...
`garch`, `glm`, `glmmadmb`, `glmmPQL`, `glmRob`, `glmrob`, `gmm`, `ivreg`,
...
```{r nlmer, warning = FALSE, message = FALSE, fig.height = 5, fig.width = 6, eval=FALSE}
# model
library(lme4)
set.seed(123)
