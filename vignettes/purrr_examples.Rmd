...
```{r purrr_ggbetweenstats, warning = FALSE, message = FALSE, fig.height = 18, fig.width = 8}
library(ggstatsplot)
...
```{r purrr_ggscatterstats, warning = FALSE, message = FALSE, fig.height = 12, fig.width = 8}
# for reproducibility
set.seed(123)
...
```{r purrr_ggcorrmat, warning = FALSE, message = FALSE, fig.height = 16, fig.width = 8}
# splitting the dataframe by cut and creting a list
# also, to make this fast, let's only use 10% of the sample
...
```{r purrr_gghistostats, warning = FALSE, message = FALSE, fig.height = 10, fig.width = 10}
# for reproducibility
set.seed(123)
