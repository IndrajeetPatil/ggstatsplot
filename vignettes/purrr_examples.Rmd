...
Most of the `ggstatsplot` functions have `grouped_` variants, which are designed to
 ...
 * A single `chr` string such as `xlab = "Continent"` or numeric such as `nboot = 25` in which case it will be reused/recycled as many times as needed.
...
```{r purrr_ggbetweenstats3, warning = FALSE, message = FALSE, fig.height = 10, fig.width = 7}
