...
To reduce the processing time, let's only work with 30% of the datset.
...
ggstatsplot::ggscatterstats(
  data = movies_30,                                            # dataframe from which variables are to be taken
  ...
  centrality.para = "mean",                                    # which type of centrality parameter to be plotted
...
There is indeed a smal,l but significant, positive correlation between the amount of money
studio invests in a movie and the ratings given by the audiences. 
...
plot_list2 <- purrr::pmap(
  .l = list(
    # let's use only 10% of the data to speed up the calculations
